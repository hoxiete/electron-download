...
const config = {
  state: {
    strategy: [{ key: 1, name: 'javbus1', strategy: '.nthread_firstpostbox img.zoom' }, { key: 2, name: 'pickpig2', strategy: '.nthread_firstpostbox img.zoo' },{ key: 3, name: 'javbus3', strategy: '.nthread_firstpostbox img.zoom' }, { key: 4, name: 'pickpig4', strategy: '.nthread_firstpostbox img.zoo' },{ key: 5, name: 'javbus5', strategy: '.nthread_firstpostbox img.zoom' }, { key: 6, name: 'pickpig6', strategy: '.nthread_firstpostbox img.zoo' }],
    currentStrategy: ''
  },
